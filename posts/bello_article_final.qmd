...
ggplot(yank_df, aes(x = reorder(name, ERA), y = ERA)) + 
  ...
  labs(
    title = "Lowest ERA for Red Sox starters in first 5 games v. NYY", 
    subtitle = "Since the Deadball Era(1920).", 
    x = ""
  ) + 
  theme(
